...
imgRouter.get("/", middleware_1.middleware, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                image = _a.sent();
                middleware_1.requestCache.set("".concat(filename, "_").concat(width, "_").concat(height), image);
