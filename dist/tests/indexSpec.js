...
describe("test endpoint response", function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              (0, supertest_1.default)(index_1.default).get("/"),
            ];
          case 1:
            response = _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              (0, supertest_1.default)(index_1.default).get("/api"),
            ];
          case 1:
            response = _a.sent();
            expect(response.status).toBe(200);
  ...
  it("gets the /api/images endpoint with valid parameters", function () {
    return __awaiter(_this, void 0, void 0, function () {
      var response;
      return __generator(this, function (_a) {
        switch (_a.label) {
  ...
  it("should return 404 status for non-existing filename", function () {
    return __awaiter(_this, void 0, void 0, function () {
      var response;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              (0, supertest_1.default)(index_1.default).get(
                "/api/image?filename=nonexisting"
              ),
            ];
          case 1:
            response = _a.sent();
  ...
  it("should return 400 status for invalid filename", function () {
    return __awaiter(_this, void 0, void 0, function () {
      var response;
      return __generator(this, function (_a) {
        switch (_a.label) {
  ...
  it("should return 400 status for invalid width", function () {
    return __awaiter(_this, void 0, void 0, function () {
      var response;
      return __generator(this, function (_a) {
        switch (_a.label) {
  ...
  it("should return 400 status for invalid height", function () {
    return __awaiter(_this, void 0, void 0, function () {
      var response;
      return __generator(this, function (_a) {
        switch (_a.label) {
