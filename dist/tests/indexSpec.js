...
describe("test endpoint response", function () {
    ...
    it("should return 400 status for invalid filename", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(index_1.default).get("/api/image?width=100&height=100")];
                case 1:
                    response = _a.sent();
...
describe("image resize function", function () {
    ...
    it("should reject when dimensions are invalid", function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                (0, resizeImage_1.default)("santamonica", -100, -100);
                return [2 /*return*/];
            });
        });
    });
